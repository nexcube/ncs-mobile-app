...
const apiInquirySearchByDepart = async (searchString, offset, fetchCount, onSuccess, onFail) => {
  const url = '/inquiry/searchByDepart';
...
export default apiInquirySearchByDepart;
