...
const apiInquirySearchByStaff = async (searchString, offset, fetchCount, onSuccess, onFail) => {
  const url = '/inquiry/searchByStaff';
...
export default apiInquirySearchByStaff;
